window.configs = {
    apiUrlInv:'/choreo-apis/beuc/ballerinafinal/inventory-a4c/v1.0',
    apiUrlConfig:'/choreo-apis/beuc/ballerinafinal/configcodes-631/v1.0',
    apiUrlUser:'/choreo-apis/beuc/ballerinafinal/user-27c/v1.0',
