...
export class TokenInterceptor implements HttpInterceptor {
  ...
  intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    request.url.includes('/getFavoriteCards') ||request.url.includes('/apprList') ||request.url.includes('/checkVehicleAvailable')
    ...
    ||request.url.includes('/getUser') ||request.url.includes('/showUser') ||request.url.includes('/addUser') ||request.url.includes('/editUser') ||request.url.includes('/uploadProPic') ||request.url.includes('/downloadImage') ||request.url.includes('/pet/findByStatus?status=available')
    ){
